...
\hypersetup{
  ...
  pdfkeywords={agent-based modelling, education, open educational resources, archaeological skills, computational skills, simulation, teaching},
  hidelinks,
...
\begin{figure}
\includegraphics[width=1\linewidth]{figures/CollageWorkshops} \caption{Impression of various workshops (CAA 2023 in Amsterdam and EAA 2023 in Belfast) with participants working.}\label{fig:workshop-impression}
\end{figure}
