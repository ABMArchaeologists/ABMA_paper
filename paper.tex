...
\author{}
\date{\vspace{-2.5em}March 17, 2025}
...
\emph{From review: Although the point can be somewhat interpreted throughout the manuscript, I would strongly suggest that the authors make a brief discussion of the experience (i.e.~the iterative design and testing of educational material),}
...
\emph{From review: particularly in light of shortcomings and resistances to digital (and computational) skills in archaeology.}
