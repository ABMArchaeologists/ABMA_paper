...
For the further dissemination of the tutorials a website has been launced^[https://ABMArchaeologists.github.io/ABMA_Website/#/]. The tutorials can be found on this website and there is a link that can be used for feedback. Additionally, the website contains: basic explanations of agent-based modelling, a recording from one of the workshops, videos from an online course at Leiden University [@spoc2019] and external resources people can use to learn agent-based modelling.
