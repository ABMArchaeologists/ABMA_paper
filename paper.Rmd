...
```{r nationality, dpi=600, fig.cap="The nationality of the participants that filled in the survey.", fig.height=5, echo=FALSE}
pre_surveys %>% 
...
```{r gender-age, dpi=600, fig.cap="The gender and age distribution of the respondents for each workshop.", fig.width=11, echo=FALSE}
...
```{r, computer-skills, dpi=600, fig.cap="The computer skills of the respondents.", out.width="50%", echo=FALSE}
pre_surveys %>%
...
```{r, abm-knowledge, dpi=600, fig.cap="Respondents knowledge of ABM per event (top), and knowledge of the various softwares for ABM (bottom), before participating in the workshops.", echo=FALSE}
...
```{r, available-theory, dpi=600, fig.cap="Respondents opinion on the quality of theory on ABM faceted out by event.", fig.width=11, echo=FALSE}
pre_surveys %>%
...
```{r, rating-workshop, dpi=600, fig.cap="Respondents rating of the workshop in general faceted for each event.", fig.width=11, echo=FALSE}
post_surveys %>%
...
```{r, rating-teaching, dpi=600, fig.cap="Respondents rating of the teaching material (top) and teachers (bottom) in general faceted for each event.", fig.width=11, fig.height=8, echo=FALSE}
