...
: Conferences, events and workshops at which the tutorials were delivered and tested.
...
The final tutorals are available for download at <https://github.com/ABMArchaeologists/ABMA_tutorials> and are citeable [@rocks-macqueen2024]. The set of developed tutorials consists of the following tutorials:
