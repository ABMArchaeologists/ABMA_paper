...
While Agent-Based Modelling importance in archaeological practice is steadily growing \_\_\_ !!!please add the following reference here: <https://www.researchgate.net/publication/376410267_Bibliometric_Analysis_of_Agent-Based_Simulation_in_Archaeology_People_Topics_and_Future_Prospects> \_\_\_, there are significant bariers to its wider adoption. One of the sectorial problems is the access to vocational training required to gain the necessary computer programming and modelling skills. A survey of practitioners [@davies2018] found significant deficiencies in the provision of ABM training; 76% of modellers were primarily self-taught with some degree of secondary support i.e. 27% relied on peer support, only 7% had any sort of formal training at a workshop or summer school while 14% received training as part of a degree.
...
[!!!COMMENT: this sentence should go into the acknowledgements] This project, Agent-Based Modelling for Archaeologists (<https://erasmus-plus.ec.europa.eu/nl/projects/search/details/2021-2-IE01-KA220-VET-000049054>), was delivered with the support of the Erasmus+ programme of the European Union.
...
-   Development of the framework for skills acquisition aligned with the Digital Skills Passport !!!\_\_ add ref here!
...
3.  !!! [Comment: This is very unclear. Currently it reads as if taking the course will make people emigrage to other countries. I don't think that is in any way true. Also, most readers would not know what European or Sectoral Framework we are referring to] improved transnational mobility through matching of the skills being delivered with European and Sectoral Frameworks, leading to individual workers being better enabled to demonstrate their skills to employers across Europe;
...
: Events at which the tutorials were delivered and tested.
...
In tutorial 2 the user learns the basics of programming in NetLogo and develops their first simulation based on a previously published model of the Out of Africa dispersal of *Homo sapiens !!! Pls insert the following reference*
...
A large proportion of the participants of the workshops gave us information using the survey before the workshops (172 of 368 participants). The respondents came from !!! COMMENT PLS ADD THE NUMBER countries that represented almost all continents (see Figure \@ref(fig:nationality). There was a clear skew towards participants from !!! COMMENT what part of the world? Europe? South America. The number of women and men in our sample were close to equal (see Figure \@ref(fig:gender-age)). The ages of the respondents ranged from below 20 to over 70, although the majority fell between 20 and 40 years old indicating that the audience was predominantly composed of early career archaeologists. It seems that the different events also had a slightly different distribution of both gender and age. For example, more older people attended the workshop at the CAA conference in April 2023 and more men were present during the workshop at the Reuvensdagen in November 2023. COMMENT - in the last sentence, are these significant differences? And if so, please provide the possible reasons for these differences.
...
Most of the respondents reported having a level of computer literacy already including particular computational skills common in archaeology, for example !!! COMMENT pls add the most popular ones (see Figure \@ref(fig:computer-skills)), and !!! COMMENT PLS insert the % number here had some prior knowledge of ABM, while !!! COMMENT PLS insert the % number here was completely new to the subject. The majority !!! COMMENT PLS insert the % number here had never applied ABM to their research before participating in the workshops with only 14 participants who had experience of developing archaeological ABM. It is interesting to note that many respondents (!!! COMMENT PLS insert the % number here) did know what kind of software was available for ABM (see Figure \@ref(fig:abm-knowledge)).
...
As shown above, the respondents had some knowledge on ABM in general, but did not know how to apply it or had never applied it before. The respondents were also asked how they rated the availability of ABM educational resources (Figure \@ref(fig:available-theory)). While *!!! COMMENT PLS insert the % number here* of them had no opinion on the subject, a !!! COMMENT PLS insert the % number here proportion of the responded answered that they rated the available theory on ABM as limited and only a smaller group !!! COMMENT PLS insert the % number here as sufficient or as more than sufficient. This clearly shows the need for more and better educational material.
...
*!!! COMMENT PLS insert the % number here* of the respondents were enthusiastic about the teaching material, with the majority rating it as excellent or good. The teachers were rated even higher than the teaching material, with more respondents giving them the *excellent* score (see Figure \@ref(fig:rating-teaching)).
...
Two open questions were asked to the respondents: *!!! COMMENT PLS spell out the questions*
...
Funding acknowledgements: the publication was financed by The Carlsberg Foundation's *Young Researcher Fellowship* (CF21-0382); IR was supported by the European Union’s Horizon 2020 Research and
Innovation Programme under the Marie Skłodowska-Curie grant agreement no 754513 and the
