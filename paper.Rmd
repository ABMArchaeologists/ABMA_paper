...
```{r, available-theory, fig.cap="Respondents optionion on the quality of theory on ABM faceted out by event.", fig.width=11}
pre_surveys %>%
...
```{r, rating-workshop, fig.cap="Respondents rating of the workshop in general faceted for each event.", fig.width=11}
post_surveys %>%
...
```{r, rating-teaching, fig.cap="Respondents rating of the teaching material in general faceted for each event.", fig.width=11, fig.show='hold', out.height="50%"}
post_surveys %>%
...
```{r, future-abm, fig.cap="The respondents reaction to the question if they thing that they will apply ABM in the future."}
post_surveys %>%
